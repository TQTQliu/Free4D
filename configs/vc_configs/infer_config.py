...
def get_parser():
    ...
    ## general
    parser.add_argument('--image_dir', type=str, default='', help='Image file path')
    ...
    ## diffusion
    parser.add_argument("--ckpt_path", type=str, default='./ckpt/vc/model.ckpt', help="checkpoint path")
    parser.add_argument("--config", type=str, default='./configs/vc_configs/inference_pvd_1024.yaml', help="config (yaml) path")
    ...
    parser.add_argument('--recon', type=str, default='monst3r')
    
    parser.add_argument('--batch_size', default=1)
    parser.add_argument('--model_path', type=str, default='./checkpoints/MonST3R_PO-TA-S-W_ViTLarge_BaseDecoder_512_dpt.pth', help='The path of the model')
    # ## dust3r
    ...
    parser.add_argument("--seq_name", type=str, default='monst3r_out', help="Sequence name for evaluation")
